...
class ReviewUpdateModel(BaseModel):
    ...
    rating: Optional[float] = Field(None, ge=0.0, le=1.0, description='Rating of the review')
    media_id: Optional[int] = Field(None, description='ID of the media the review is about')
    reviewer_id: Optional[int] = Field(None, description='ID of the user who made the review')
