...
class ReviewBaseModel(BaseModel):
    title: Optional[float] = Field("Untitled", min_length=1, description='Title of the review')
    description: Optional[float] = Field("", description='Description of the review')
    rating: Optional[float] = Field(None, ge=0.0, le=1.0, description='Rating of the review')
    media_id: int = Field(..., ge=1, description='ID of the media the review is about')
    reviewer_id: int = Field(..., ge=1, description='ID of the user who made the review')
